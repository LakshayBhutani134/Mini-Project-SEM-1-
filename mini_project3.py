...
bg_image = pygame.image.load("Mini_Project\\background69.jpeg").convert_alpha()

#load spritesheets
hero_sheet = pygame.image.load("Mini_Project\sprites\warrior1.png").convert_alpha()
villain_sheet = pygame.image.load("Mini_Project\KaalaJaaduwala.png").convert_alpha()

#load victory image
victory_img = pygame.image.load("Mini_Project\\victory9.png").convert_alpha()

#load defeat image
defeat_img = pygame.image.load("Mini_Project\defeat2.png").convert_alpha()
...
#define font
count_font=pygame.font.Font("Mini_Project\Turok.ttf", 80)
score_font=pygame.font.Font("Mini_Project\Turok.ttf", 30)
